...
public class WebAppRootConfig {
    ...
    public DataSource dataSource() {
        ...
        dmds.setUrl("jdbc:mysql://localhost:3306/burgershop?createDatabaseIfNotExist=true");
        dmds.setUsername("root");
        dmds.setPassword("2002");
        return dmds;
    }
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("lk.ijse.burgershopposbackend.entity");
